...
static int _init_##name = []() {Token::setTokenName(name.value, string); return 0;}();
...
struct hash<Token> {
	...
	constexpr size_t operator()(const Token &x) const noexcept { return hash<std::size_t>()(x.value); }
};
}	  // namespace std
